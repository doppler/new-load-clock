...
const Settings = () => {
  const { graph, celsius, windsAloft, dispatch } = useContext(SettingsContext);
      ...
      <div className="LoadClocks" locationname="Settings">
        ...
        <section>
          ...
          <ul>
            ...
            <li onClick={() => toggleBoolSetting("windsAloft")}>
              <input type="checkbox" checked={windsAloft || false} readOnly />
